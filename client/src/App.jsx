...
function App() {
  ...
  return (
      <>
        ...
        { definition && <Body definition={definition} isLoading={isLoading} /> }
        { definition.title && <Fail title={definition.title} message={definition.message} resolution={definition.resolution} /> }
      </> 
  )
}
